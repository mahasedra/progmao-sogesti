...
<v-card class="spacing-playground ma-5">
    <v-data-table :options="{ openLink }" :headers="headers" :items="gestionSecurite" :search="search" class="elevation-4" :loading="loading" loading-text="Chargement...Veuillez patienter">
        <template v-slot:top>
            <v-toolbar flat>
                            ...
                            <v-row>
                                <v-col cols="12">
                                    <v-row>
                                        <v-col cols="12">
                                            <h4>Intitulé</h4>
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="defaultItem.intitulePassation" label="Intitulé de la passation" :rules="titleRule">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="defaultItem.nomEtPrenomAgentEntrant" label="Agent entrant">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="defaultItem.nomEtPrenomAgentSortant" label="Agent sortant">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="defaultItem.vacation" label="Vacation"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <center>
                                        <h1 style="font-weight: bold">Arme</h1>
                                    </center>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="defaultItem.typeArme" label="Type de l'arme"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="defaultItem.modeleArme" label="Modèle de l'arme"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="defaultItem.etatArme" label="Etat"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.anomaliesArme" label="Anomalies">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.observationsArme" label="Observations">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            ...
                                            <input type="date" v-model="defaultItem.dateSortieArme" class="datepicker" />
                                    ...
                                    <v-row>
                                        <v-col cols="12">
                                            ...
                                            <input type="date" v-model="defaultItem.dateRetourArme" class="datepicker" />
                                        </v-col>
                                    </v-row>
                                    <center>
                                        <h1 style="font-weight: bold">Munition</h1>
                                    </center>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.typeMunition" label="Type de munition">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.modeleMunition" label="Modèle de munition">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.nbreRecuesMunition" label="Nombre de munitions reçues">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.nbreUtiliseMunition" label="Nombre de munitions utilisées">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.nbreRestantesMunition" label="Nombre de munitions restantes">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.nbreUseesMunition" label="Nombre de munitions usées">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.nbreDetruitesMunition" label="Nombre de munitions détruites">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="defaultItem.observationMunition" label="Observations">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                            ...
                            <v-row>
                                <v-col cols="12">
                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <h4>Intitulé</h4>
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="editedItem.intitulePassation" label="Intitulé de la passation" :rules="titleRule">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="editedItem.nomEtPrenomAgentEntrant" label="Agent entrant">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="editedItem.nomEtPrenomAgentSortant" label="Agent sortant">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="editedItem.vacation" label="Vacation"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <center>
                                        <h1 style="font-weight: bold">Arme</h1>
                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="editedItem.typeArme" label="Type de l'arme"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="editedItem.modeleArme" label="Modèle de l'arme"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field outlined prepend-inner-icon="mdi-account-details-outline" v-model="editedItem.etatArme" label="Etat"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.anomaliesArme" label="Anomalies">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.observationsArme" label="Observations">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <h3>Date de sortie</h3>
                                            <input type="date" v-model="editedItem.dateSortieArme" class="datepicker" />
                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <h3>Date de retour</h3>
                                            <input type="date" v-model="editedItem.dateRetourArme" class="datepicker" />
                                        </v-col>
                                    </v-row>
                                    <center>
                                        <h1 style="font-weight: bold">Munition</h1>
                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.typeMunition" label="Type de munition">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.modeleMunition" label="Modèle de munition">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.nbreRecuesMunition" label="Nombre de munitions reçues">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.nbreUtiliseMunition" label="Nombre de munitions utilisées">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.nbreRestantesMunition" label="Nombre de munitions restantes">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.nbreUseesMunition" label="Nombre de munitions usées">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.nbreDetruitesMunition" label="Nombre de munitions détruites">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="10" md="10">
                                            <v-text-field prepend-inner-icon="mdi-format-align-justify" v-model="editedItem.observationMunition" label="Observations">
                                            </v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                    ...
                                    <v-divider></v-divider>
                                    <br>
                                    <v-col cols="12" sm="10" md="10" v-if="editedItem.customFieldsData && editedItem.customFieldsData.length > 0">
    ...
    data() {
        return {
            ...
            editedItem: {
                ...
                nbreRecuesMunition: "",
                nbreUtiliseMunition: "",
                nbreRestantesMunition: "",
                nbreUseesMunition: "",
                nbreDetruitesMunition: "",
                observationMunition: "",
    ...
    methods: {
        ...
        async sendMail() {
            ...
            let Columns = [{
                ...
                {
                    header: "Anomalies (Arme)",
                    key: "anomaliesArme",
                },
                {
                    header: "Date de sortie (Arme)",
                    key: "dateSortieArme",
                },
                {
                    header: "Date de retour (Arme)",
                    key: "dateRetourArme",
                },
                {
                    header: "Type (Munition)",
                    key: "typeMunition"
                },
                {
                    header: "Modèle (Munition)",
                    key: "modeleMunition"
                },
                {
                    header: "Munitions reçues",
                    key: "nbreRecuesMunition",
                },
                {
                    header: "Munitions utilisées",
                    key: "nbreUtiliseMunition",
                },
                {
                    header: "Munitions restantes",
                    key: "nbreRestantesMunition",
                },
                {
                    header: "Munitions usées",
                    key: "nbreUseesMunition",
                },
                {
                    header: "Munitions détruites (Cartouches à blancs 9mm TG6768AW)",
                    key: "nbreDetruitesMunition",
                },
            ];
            this.loading = true;
            var m = new Date();
            ...
            Columns.forEach((element) => {
                doc.text(element["header"], 10, i, {
                    align: "left",
                });
                i = i + 10;
                doc.setTextColor(255, 0, 0);
                doc.text(documents[0][element["key"]], 10, i, {
                    align: "left",
                });
                doc.setTextColor(0, 2, 3);
                if (i >= pageHeight) {
        ...
        exportPDF() {
            ...
            import("jspdf").then(jsPDF => {
                import("jspdf-autotable").then(() => {
                    ...
                    doc.setFontSize(16);
                    doc.setFont("helvetica");
                    doc.text("Liste des passations d'armes et munitions", 30, 30, {
                        align: "justify",
                    });
        ...
        viewItem(item) {
            this.editedIndex = this.gestionSecurite.indexOf(item);
            this.editedItem = Object.assign({}, item);
            this.editedItem["dateSortieArme"] = moment(this.editedItem["dateSortieArme"], 'DD-MM-YYYY HH:mm').format('YYYY-MM-DD');
            this.editedItem["dateRetourArme"] = moment(this.editedItem["dateRetourArme"], 'DD-MM-YYYY HH:mm').format('YYYY-MM-DD');
